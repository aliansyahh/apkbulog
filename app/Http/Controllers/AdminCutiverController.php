<?php namespace App\Http\Controllers;
	...
	class AdminCutiverController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
	        ...
	        */
            ...
            $this->addaction[] = ['url'=>CRUDBooster::mainpath('set-status/Sudah Verifikasi/[id]'),'icon'=>'fa fa-check','color'=>'success','showIf'=>"[keterangan] == 'Belum Verifikasi'"];
            $this->addaction[] = ['url'=>CRUDBooster::mainpath('set-status/Belum Verifikasi/[id]'),'icon'=>'fa fa-ban','color'=>'success','showIf'=>"[keterangan] == 'Sudah Verifikasi'"];
	    ...
	    */
        ...
        public function getSetStatus($status,$id) {		
			DB::table('tb_laporan_cuti')->where('id',$id)->update(['keterangan'=>$status]);
			CRUDBooster::redirect($_SERVER['HTTP_REFERER'],"Ok!","success");
		}
