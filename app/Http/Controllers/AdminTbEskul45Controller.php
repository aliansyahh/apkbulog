<?php namespace App\Http\Controllers;
	...
	class AdminTbEskul45Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Kelas","name"=>"kelas","join"=>"tb_pdidik,kelas"];
			...
			$this->col[] = ["label"=>"Eskul","name"=>"eskul"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Nama Siswa','name'=>'nama_siswa','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Kelas','name'=>'kelas','type'=>'datamodal','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label' => 'Kelas', 'name' => 'kelas', 'type' => 'datamodal', 'validation' => 'required|string|min:0|max:70', 'width' => 'col-sm-10', 'datamodal_table' => 'tb_pdidik', 'datamodal_columns' => 'kelas,nama_siswa,jk', 'datamodal_columns_alias' => 'kelas,nama_siswa,jk', 'datamodal_select_to' => 'kelas:kelas,nama_siswa:nama_siswa,tempat_lahir:tempat_lahir,tanggal_lahir:tanggal_lahir,jk:jk,alamat:alamat', 'datamodal_size' => 'small', 'required' => true];
			...
			$this->form[] = ['label'=>'Eskul','name'=>'eskul','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			# END FORM DO NOT REMOVE THIS LINE

			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Nama Sis","name"=>"nama_sis","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			...
			//$this->form[] = ["label"=>"Eskul","name"=>"eskul","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			# OLD END FORM
	    ...
	    */
		...
		public function getCetak(){
			$data ['page_title'] = " data ekstrakulikuler ";
			$data ['tb_eskul'] = DB::table('tb_eskul')
			->join('tb_pdidik', 'tb_eskul.kelas', '=', 'tb_pdidik.id')
			->get();
			$pdf = PDF::loadView('dataeskul',$data)->setpaper('a3','landscape');

			return $pdf->stream('dataekstrakulikuler-pdf.pdf');
		}
