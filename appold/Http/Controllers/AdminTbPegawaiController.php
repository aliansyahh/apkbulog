<?php namespace App\Http\Controllers;
	...
	class AdminTbPegawaiController extends \crocodicstudio\crudbooster\controllers\CBController {

	    public function cbInit() {

			# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->title_field = "DataPegawai";
			$this->limit = "30";
			...
			$this->form[] = ['label'=>'No Hp','name'=>'no_hp','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
