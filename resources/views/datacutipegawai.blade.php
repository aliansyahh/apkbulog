...
@foreach($tb_laporan_cuti as $data2)
...
<table center="center" >
    ...
    <table center="center">
        <tr align='center'>
            <td>
         <tr>
    <font size="20"><b> Laporan Cuti Pegawai</b><br>
        <br>
<table border='1' width='100%' cellpadding='3' cellspacing="0" style='border-collapse: collapse;font-size:14px'>
    <tr align="center">
        ...
        @foreach($tb_laporan_cuti as $detail)
            <tr>
                <td align='center'>{{$detail->nip}}</td>
                <td align='center'>{{$detail->nama}}</td>
                <td align='center'>{{$detail->jabatan}}</td>
                <td align='center'>{{$detail->jenis_cuti}}</td>
                <td align='center'>{{$detail->dari_tanggal}}</td>
                <td align='center'>{{$detail->sampai_tanggal}}</td>
